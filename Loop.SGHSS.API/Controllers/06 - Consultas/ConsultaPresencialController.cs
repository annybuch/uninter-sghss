...
{
    [ApiController, Route("api/v1/consulta-presencial"),
    Tags("06.2 📝 Consultas presenciais, fluxo responsável por marcar uma consulta PRESENCIAL.")]
    public class ConsultaPresencialController : LoopContoller
    {
        private readonly IConsultaService _consultaService;
        private readonly IEspecializacaoService _especializacaoService;

        public ConsultaPresencialController(IConsultaService consultaService, IEspecializacaoService especializacaoService)
        {
        ...
        /// <summary>
        /// 2 - Responsável por buscar instituições que têm disponibilidade para a especialização escolhida.
        /// </summary>
        ...
        {
            return Ok(await _consultaService.BuscarInstituicoesComDisponibilidade(especializacaoId, tipoConsulta));
        }
        ...
        public async Task<IActionResult> Get(Guid instituicaoId, Guid especializacaoId, TipoConsultaEnum tipoConsulta)
        {
            return Ok(await _consultaService.ObterProfissionaisComHorarios(especializacaoId, tipoConsulta, instituicaoId));
        }

        /// <summary>
        /// 4 - Responsável por marcar uma consulta em uma instituição.
        /// </summary>
